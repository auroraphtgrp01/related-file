...
public class SleepActivity extends BaseActivity implements CalendarView.OnCalendarSelectListener, CalendarView.OnMonthChangeListener {
    private String date;
    ...
    @BindView(R.id.tv_total_sleep_text)
    ...
    private void getCurrData() {
        ...
        new Thread(new Runnable() { // from class: com.yucheng.smarthealthpro.home.activity.sleep.activity.SleepActivity.2
    ...
    public void initViewPager() {
        ...
        SleepTabFragmentAdapter sleepTabFragmentAdapter = new SleepTabFragmentAdapter(getSupportFragmentManager(), new SleepTabFragmentAdapter.FragmentCreator() { // from class: com.yucheng.smarthealthpro.home.activity.sleep.activity.SleepActivity.3
            ...
            public Fragment createFragment(String str, int i2) {
                return SleepTabFragment.newInstance(str.toString(), i2, SleepActivity.this.mNestedScrollView, SleepActivity.this.monthLastDay, SleepActivity.this.mDaySleepChartDataBeans, SleepActivity.this.mWeekSleepChartDataBeans, SleepActivity.this.mMonthSleepChartDataBeans);
            }
    ...
    private class OnPageChangeListenerImpl implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int i2) {
            SleepActivity.this.mViewPager.setCurrentItem(i2);
            if (i2 == 0) {
    ...
    public void freshDayData() {
        ...
        if (this.mDaySleepDeepSleepTotal != 0 || this.mDaySleepLightSleepTotal != 0) {
            ...
            dataAnalysis(-1.0f);
            this.tvTotalSleep.setText(HelpFormatter.DEFAULT_LONG_OPT_PREFIX);
        }
    ...
    private void initMonth() {
        ...
        this.mCalendarView.setOnCalendarInterceptListener(new CalendarView.OnCalendarInterceptListener() { // from class: com.yucheng.smarthealthpro.home.activity.sleep.activity.SleepActivity.4
            ...
            if (queryIdYearToDay != null) {
                ...
                while (i4 < this.mSleepDb.size()) {
                    ...
                    if (TimeStampUtils.dateForStringYearToDate(TimeStampUtils.longStampForDate(sleepDb.getStartTime())).equals(pastDateString)) {
                        Integer.parseInt(TimeStampUtils.dateForStringToHourDate(TimeStampUtils.longStampForDate(sleepDb.getStartTime())));
                        Integer.parseInt(TimeStampUtils.dateForStringToHourDate(TimeStampUtils.longStampForDate(sleepDb.getEndTime())));
                        Logger.d("chong---------startTime==" + sleepDb.getStartTime());
                        if (this.mDaySleepDeepSleepTotal + sleepDb.getDeepSleepTotal() + this.mDaySleepLightSleepTotal + sleepDb.getLightSleepTotal() + this.mDaySleepRemTotal + sleepDb.getRapidEyeMovementTotal() <= 57600 && SleepUtil.isTodaySleep(sleepDb, i3)) {
    ...
    /*  JADX ERROR: NullPointerException in pass: LoopRegionVisitor
        ...
        */
    private void setDayCharData(java.lang.String r14) {
        /*
            r13 = this;
            java.lang.String r0 = ":"
            java.lang.String r1 = "HH:mm"
            com.google.gson.Gson r2 = new com.google.gson.Gson     // Catch: com.google.gson.JsonSyntaxException -> L19
            r2.<init>()     // Catch: com.google.gson.JsonSyntaxException -> L19
            com.yucheng.smarthealthpro.home.activity.sleep.activity.SleepActivity$5 r3 = new com.yucheng.smarthealthpro.home.activity.sleep.activity.SleepActivity$5     // Catch: com.google.gson.JsonSyntaxException -> L19
            r3.<init>()     // Catch: com.google.gson.JsonSyntaxException -> L19
            java.lang.reflect.Type r3 = r3.getType()     // Catch: com.google.gson.JsonSyntaxException -> L19
            java.lang.Object r14 = r2.fromJson(r14, r3)     // Catch: com.google.gson.JsonSyntaxException -> L19
            java.util.List r14 = (java.util.List) r14     // Catch: com.google.gson.JsonSyntaxException -> L19
            goto L1e
        L19:
            r14 = move-exception
            r14.printStackTrace()
        ...
        L23:
            ...
            com.yucheng.smarthealthpro.home.bean.SleepResponse$SleepDataBean$SleepData r4 = (com.yucheng.smarthealthpro.home.bean.SleepResponse.SleepDataBean.SleepData) r4
            long r5 = r4.getSleepStartTime()
            int r7 = r4.getSleepType()
            r7 = r7 & 15
            if (r7 != 0) goto L3c
            r7 = 2
        L3c:
            int r4 = r4.getSleepLen()
            r8 = 9999999999(0x2540be3ff, double:4.940656458E-314)
            int r8 = (r5 > r8 ? 1 : (r5 == r8 ? 0 : -1))
            r9 = 1000(0x3e8, double:4.94E-321)
            if (r8 >= 0) goto L4c
            long r5 = r5 * r9
        L4c:
            com.yucheng.smarthealthpro.home.activity.sleep.bean.SleepDayInfo r8 = new com.yucheng.smarthealthpro.home.activity.sleep.bean.SleepDayInfo     // Catch: java.lang.Exception -> Lc0
            r8.<init>()     // Catch: java.lang.Exception -> Lc0
            java.lang.Long r11 = java.lang.Long.valueOf(r5)     // Catch: java.lang.Exception -> Lc0
            java.lang.String r11 = com.yucheng.smarthealthpro.customchart.sleep.SleepBarChartUtils.transferLongToDate(r1, r11)     // Catch: java.lang.Exception -> Lc0
            r8.beginTimes = r11     // Catch: java.lang.Exception -> Lc0
            long r11 = (long) r4     // Catch: java.lang.Exception -> Lc0
            long r11 = r11 * r9
            long r11 = r11 + r5
            java.lang.Long r4 = java.lang.Long.valueOf(r11)     // Catch: java.lang.Exception -> Lc0
            java.lang.String r4 = com.yucheng.smarthealthpro.customchart.sleep.SleepBarChartUtils.transferLongToDate(r1, r4)     // Catch: java.lang.Exception -> Lc0
            r8.endTimes = r4     // Catch: java.lang.Exception -> Lc0
            java.lang.String r4 = r8.beginTimes     // Catch: java.lang.Exception -> Lc0
            java.lang.String[] r4 = r4.split(r0)     // Catch: java.lang.Exception -> Lc0
            java.lang.String r9 = r8.endTimes     // Catch: java.lang.Exception -> Lc0
            java.lang.String[] r9 = r9.split(r0)     // Catch: java.lang.Exception -> Lc0
            r10 = r4[r2]     // Catch: java.lang.Exception -> Lc0
            int r10 = java.lang.Integer.parseInt(r10)     // Catch: java.lang.Exception -> Lc0
            int r10 = r10 * 60
            r11 = 1
            r4 = r4[r11]     // Catch: java.lang.Exception -> Lc0
            int r4 = java.lang.Integer.parseInt(r4)     // Catch: java.lang.Exception -> Lc0
            int r10 = r10 + r4
            r8.beginTime = r10     // Catch: java.lang.Exception -> Lc0
            r4 = r9[r2]     // Catch: java.lang.Exception -> Lc0
            int r4 = java.lang.Integer.parseInt(r4)     // Catch: java.lang.Exception -> Lc0
            int r4 = r4 * 60
            r9 = r9[r11]     // Catch: java.lang.Exception -> Lc0
            int r9 = java.lang.Integer.parseInt(r9)     // Catch: java.lang.Exception -> Lc0
            int r4 = r4 + r9
            r8.endTime = r4     // Catch: java.lang.Exception -> Lc0
            r8.type = r7     // Catch: java.lang.Exception -> Lc0
            if (r3 <= 0) goto Lba
            int r4 = r3 + (-1)
            java.lang.Object r7 = r14.get(r4)     // Catch: java.lang.Exception -> Lc0
            com.yucheng.smarthealthpro.home.bean.SleepResponse$SleepDataBean$SleepData r7 = (com.yucheng.smarthealthpro.home.bean.SleepResponse.SleepDataBean.SleepData) r7     // Catch: java.lang.Exception -> Lc0
            long r9 = r7.getSleepStartTime()     // Catch: java.lang.Exception -> Lc0
            java.lang.Object r4 = r14.get(r4)     // Catch: java.lang.Exception -> Lc0
            com.yucheng.smarthealthpro.home.bean.SleepResponse$SleepDataBean$SleepData r4 = (com.yucheng.smarthealthpro.home.bean.SleepResponse.SleepDataBean.SleepData) r4     // Catch: java.lang.Exception -> Lc0
            int r4 = r4.getSleepLen()     // Catch: java.lang.Exception -> Lc0
            int r4 = r4 * 1000
            long r11 = (long) r4     // Catch: java.lang.Exception -> Lc0
            long r9 = r9 + r11
            ...
            goto Lc4
        Lba:
            java.util.List<com.yucheng.smarthealthpro.home.activity.sleep.bean.SleepDayInfo> r4 = r13.mDaySleepChartDataBeans     // Catch: java.lang.Exception -> Lc0
        ...
        Lc8:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.yucheng.smarthealthpro.home.activity.sleep.activity.SleepActivity.setDayCharData(java.lang.String):void");
    }
        ...
        while (i11 <= i10) {
            ...
            if (this.mSleepDb != null) {
                ...
                for (int i20 = 0; i20 < this.mSleepDb.size(); i20++) {
                    ...
                    if ((hourFromTimeStamp <= 12 || !sleepDb.getTimeYearToDate().equals(pastStringArray.get(i11))) && ((hourFromTimeStamp >= 20 || !sleepDb.getTimeYearToDate().equals(pastStringArray.get(i16))) && (i20 <= 0 || sleepDb.getStartTime() <= this.mSleepDb.get(i20 - 1).getEndTime()))) {
                        int i23 = i6 + deepSleepTotal;
                        int i24 = i17 + lightSleepTotal;
                        int i25 = i18 + i21;
                        if (i23 + i24 + i25 <= 57600) {
                            if (sleepDb.getDeepSleepCount() != 65535) {
                                i22++;
            ...
            if (i3 != 0) {
                ...
                if (i9 == 7) {
                    ...
                    int i30 = i4;
                    int i31 = i5;
                    this.mWeekSleepAdapterHisListBean.add(new SleepHisListBean(j5, j6, j4, i26, i27, i28, i29, i30, "正常", i31, 0, true));
                    this.mWeekSleepChartDataBeans.add(new SleepHisListBean(j5, j6, j4, i26, i27, i28, i29, i30, "正常", i31, 0, true));
                } else if (i9 == 30) {
                    long j7 = i6 + i3 + i5;
    ...
    public void getMonthData() {
        ...
        getDataByDays(30);
        runOnUiThread(new Runnable() { // from class: com.yucheng.smarthealthpro.home.activity.sleep.activity.SleepActivity.6
            @Override // java.lang.Runnable
            public void run() {
    ...
    public void getDaySleep(final String str, final int i2) {
        ...
        hashMap.put("day", str);
        HttpUtils.getInstance().postMsgAsynHttp(this, Constants.sleepDayUrl, hashMap, new HttpUtils.HttpCallback() { // from class: com.yucheng.smarthealthpro.home.activity.sleep.activity.SleepActivity.7
                ...
                if (str2 != null) {
                    try {
                        ...
                        if (historySleepResponse != null) {
                            ...
                            if (i2 == 0) {
                                SleepActivity.this.getDaySleep(YearToDayListUtils.getPastDateString(1, new SimpleDateFormat(AppDateMgr.DF_YYYY_MM_DD).parse(str)), 1);
                                return;
                            }
    ...
    public void setDayData() {
        for (HistorySleepResponse.SleepBean sleepBean : this.mLists) {
            ...
            if (this.mDaySleepDeepSleepTotal + sleepBean.dsTimes + this.mDaySleepLightSleepTotal + sleepBean.qsTimes + this.mDaySleepRemTotal + sleepBean.remTimes <= 57600) {
                ...
                if (sleepBean.dsCount == 65535) {
                    try {
                        this.mDaySleepWakeCount += Integer.parseInt(sleepBean.wakeCount.isEmpty() ? "0" : sleepBean.wakeCount);
    ...
    private void getNetSleep(String str, String str2, String str3, final int i2) {
        ...
        HttpUtils.getInstance().postMsgAsynHttp(this, Constants.sleepDayUrl, hashMap, new HttpUtils.HttpCallback() { // from class: com.yucheng.smarthealthpro.home.activity.sleep.activity.SleepActivity.8
            ...
            public void onSuccess(String str4) {
                if (str4 != null) {
                    SleepActivity.this.parseSleepData(str4, i2);
                }
            }
        });
    }
    ...
    public void parseSleepData(String str, int i2) {
        ...
        while (true) {
            ...
            CareSleepWeekMonthBean.DataBean dataBean = list.get(i4);
        ...
        List<CareSleepWeekMonthBean.DataBean> sortWeekAndMonthListSleep = Tools.sortWeekAndMonthListSleep(list);
        ArrayList arrayList = new ArrayList();
        ...
        int i8 = 0;
        int i9 = 0;
        while (i5 < sortWeekAndMonthListSleep.size()) {
            CareSleepWeekMonthBean.DataBean dataBean2 = sortWeekAndMonthListSleep.get(i5);
            if (dataBean2.dsStatistics + i6 + dataBean2.qsStatistics + i7 + dataBean2.remTotalDuration + i8 <= i2 * i3) {
                int i10 = i6 + dataBean2.dsStatistics;
                int i11 = i7 + dataBean2.qsStatistics;
                i8 += dataBean2.remTotalDuration;
                i9 += dataBean2.count;
        ...
        for (int i13 = 0; i13 < pastStringArray.size(); i13++) {
            int i14 = 0;
            while (true) {
                if (i14 < sortWeekAndMonthListSleep.size()) {
                    CareSleepWeekMonthBean.DataBean dataBean3 = sortWeekAndMonthListSleep.get(i14);
                    if (dataBean3.dateformat.equals(pastStringArray.get(i13))) {
                        arrayList2.remove(i13);
                        arrayList2.add(i13, new SleepHisListBean(TimeStampUtils.getStringToDate(dataBean3.dateformat, AppDateMgr.DF_YYYY_MM_DD), 0L, 0L, dataBean3.dsStatistics, dataBean3.qsStatistics, 0, 0, 0, "正常", dataBean3.remTotalDuration, 0, true));
                        break;
                    }
                    i14++;
                }
        ...
        if (i2 == 7) {
            this.mWeekSleepAverageDeepSleepTotal = i6 / sortWeekAndMonthListSleep.size();
            this.mWeekSleepAverageLightSleepTotal = i7 / sortWeekAndMonthListSleep.size();
            this.mWeekSleepAverageWakeCount = i9 / sortWeekAndMonthListSleep.size();
            this.mWeekSleepAverageRemTotal = i8 / sortWeekAndMonthListSleep.size();
            this.mWeekSleepAdapterHisListBean = arrayList;
            this.mWeekSleepChartDataBeans = arrayList2;
            return;
        }
        if (i2 == 30) {
            this.mMonthSleepAverageDeepSleepTotal = i6 / sortWeekAndMonthListSleep.size();
            this.mMonthSleepAverageLightSleepTotal = i7 / sortWeekAndMonthListSleep.size();
            this.mMonthSleepAverageWakeCount = i9 / sortWeekAndMonthListSleep.size();
            this.mMonthSleepAverageRemTotal = i8 / sortWeekAndMonthListSleep.size();
        ...
        switch (view.getId()) {
            ...
            case R.id.rl_fourthly /* 2131297289 */:
                if (this.ARROW == 0) {
                    ...
                    this.ARROW = 1;
                    this.mNestedScrollView.postDelayed(new Runnable() { // from class: com.yucheng.smarthealthpro.home.activity.sleep.activity.SleepActivity.9
                        @Override // java.lang.Runnable
                        public void run() {
    ...
    public SpannableString parseMin(int i2) {
        return setSpaning(String.format("%d h %d min", Integer.valueOf(i2 / 60), Integer.valueOf(i2 % 60)));
    }
